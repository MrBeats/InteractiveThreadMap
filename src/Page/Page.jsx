        ...
        return (
            <div id={"container"} >
                ...
                <div className={"containerItem"}>
                    <h1>Terrorism</h1>
                    <br />
                    <p><strong>In Zeiten, in denen sich Terror-Organisationen wie der IS ausbreiten und ganze Staaten zerfallen,<br /> ist der <span style={{color: '#339966'}}>Terrorismus</span> ebenfalls eine sehr gro&szlig;e Gefahr in der heutigen Welt. Das <br />&nbsp;<a title="National Consortium for the Study of Terrorism and Responses to Terrorism" href="https://www.start.umd.edu/">National Consortium for the Study of Terrorism and Responses to Terrorism</a>&nbsp;(START) hat hierbei<br /> zu Forschungszwecken eine Datenbank aufgebaut, welche nahezu alle terroristischen<br /> Anschl&auml;ge auf der ganzen Wet seit 1970 dokumentiert. Zus&auml;tzlich enth&auml;lt der Datensatz oft<br /> viele Zusatzinformationen, wie die Zahl der Todesopfer, das Anschlagsziel oder die Angriffsart.<br /> Die Daten k&ouml;nnen dabei in der <a href="https://www.start.umd.edu/gtd/">Global Terrorism Database (GTD)</a> eingesehen werden.</strong></p>
                </div>
                <Waypoint onEnter={this.changeBackground.bind(this,"Corona")} />
                <div className={"containerItem"}>
                    <h1>Corona</h1>
                    <p><strong>Der <span style={{color: '#0000ff'}}>Corona</span> Virus (2019-nCoV) ist wohl die neueste und aktuellste Gefahr. Der erstmals in China aufgetretene Virus der Familie der&nbsp;<em>Coronaviridae&nbsp;</em>hat allein in China bereits mehrere zehntausend Menschen infiziert und schon &uuml;ber tausend Todesopfer gefordert (<a href="https://www.who.int/docs/default-source/coronaviruse/situation-reports/20200212-sitrep-23-ncov.pdf?sfvrsn=41e9fb78_2">Stand Februar 2020</a>). Auch wenn au&szlig;erhalb Chinas noch nicht viele F&auml;lle bekanns dind, stellt dieser Virus eine Gefahr f&uuml;r die Institute und Ihre Mitarbeiter dar. Die Daten werden dabei aus einer <a href="https://github.com/globalcitizen/2019-wuhan-coronavirus-data">unabh&auml;ngigen Quelle</a> bezogen und enthalten neben den Zahlen auch die Herkunft s&auml;mtlicher Daten.</strong></p>
                </div>
